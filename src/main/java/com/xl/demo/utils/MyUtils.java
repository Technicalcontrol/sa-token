...
import com.xl.demo.domain.vo.IpAddress;
...
public class MyUtils {
     ...
     * 核查参数是正确
     */
    public static <T> boolean checkPageParam(PageParam<T> param){
        boolean flag = false;
        if(param!=null){
            if (param.getPageIndex()!=null&&param.getPageIndex()>0 && param.getPageSize()!=null && param.getPageSize()>0){
                flag = true;
            }
        }
        return  flag;
